...
void module_do_run()
{
	while(1)
	{
		...
		c_common_datapr_multwii_debug(iInputData.attitude_reference.refroll*100,iInputData.attitude_reference.refpitch*100,iInputData.init,iInputData.securityStop);
